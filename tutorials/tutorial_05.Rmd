...
To get some more exercise into creating your own custom input bindings, consider the source code for the binding for the button group used in the dashboard application, which can be found [here](TO DO: INSERT LINK).
